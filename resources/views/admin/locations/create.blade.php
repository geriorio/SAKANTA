...
<head>
    ...
    <title>Add Location - Sakanta Admin</title>
    <style>
        ...
        <div class="card">
            <form method="POST" action="{{ route('admin.locations.store') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="image" name="image" value="{{ old('image') }}" placeholder="e.g., bali.jpg" required>
                    <small style="color: #666; display: block; margin-top: 0.5rem;">
                        Image should be placed in: public/images/locations/
                    </small>
                    @error('image')
                        <div class="error">{{ $message }}</div>
                    @enderror
